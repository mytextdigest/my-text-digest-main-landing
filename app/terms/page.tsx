...
export default function TermsPage() {
  ...
  useEffect(() => {
    async function loadDoc() {
      ...
      const response = await fetch("/legal/terms.docx");
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 max-w-5xl">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Terms of <span className="bg-gradient-to-r from-[var(--primary-500)] to-[var(--primary-700)] bg-clip-text text-transparent">Use</span>
            </h1>
