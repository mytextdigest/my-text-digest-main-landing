    ...
    <div>
      ...
      <div className="mb-10">
        <h1 className="text-3xl font-bold">
          <span className="text-[#EDEDED]">Desktop </span>
        ...
        <p className="text-[#EDEDED]/50 text-sm mt-2">
          Insights from desktop application usage
        </p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Card title="Total Users" value={data.totalUsers} icon={FiUsers} />
        <Card title="Total Subs" value={data.totalSubscriptions} icon={FiCreditCard} />
        <Card title="Active Subs" value={data.activeSubscriptions} icon={FiActivity} />
      </div>
